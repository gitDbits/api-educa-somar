...
RSpec.describe "/institutions", type: :request do
  ...
  # InstitutionsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get institutions_url, headers: valid_headers, as: :json
      ...
      it "creates a new Institution" do
        expect {
          post institutions_url,
               params: { institution: valid_attributes }, headers: valid_headers, as: :json
  ...
  describe "DELETE /destroy" do
    it "destroys the requested institution" do
      institution = Institution.create! valid_attributes
      expect {
        delete institution_url(institution), headers: valid_headers, as: :json
      }.to change(Institution, :count).by(-1)
    end
  end
end
